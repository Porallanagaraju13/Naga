    ...
    <section id="about" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="mb-16 slide-in-up">
          <h3 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center">Technical Skills</h3>
          <div className="relative min-h-[300px] sm:min-h-[400px] overflow-hidden rounded-xl sm:rounded-2xl bg-gradient-to-br from-primary/5 via-accent/5 to-tech-purple/5 backdrop-blur-sm border border-border/20">
            <div className="absolute inset-0 bg-gradient-to-r from-primary/10 via-transparent to-accent/10 animate-pulse"></div>
            <div className="relative p-4 sm:p-6 md:p-8 flex flex-wrap gap-2 sm:gap-3 md:gap-4 justify-center items-center min-h-[300px] sm:min-h-[400px]">
              {skillsData.map((skill, index) => (
                ...
                >
                  <div className={`
                    relative px-3 py-1.5 sm:px-4 sm:py-2 md:px-6 md:py-3 rounded-full 
