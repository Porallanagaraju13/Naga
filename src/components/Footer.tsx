  ...
  return (
    <footer className="bg-secondary/20 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 sm:gap-8 mb-6 sm:mb-8">
          ...
          <div className="space-y-3 sm:space-y-4 sm:col-span-2 md:col-span-1">
            <div className="flex items-center gap-2 sm:gap-3">
              ...
              <span className="font-bold text-lg sm:text-xl text-gradient">Nagaraju Poralla</span>
            </div>
        ...
        {/* Bottom Section */}
        <div className="flex flex-col sm:flex-row items-center justify-between pt-6 sm:pt-8 border-t border-border gap-4">
          ...
          <Button
            ...
            size="sm"
            onClick={scrollToTop}
            className="group hover:border-primary/50 text-xs sm:text-sm"
          >
            <ArrowUp className="w-3 h-3 sm:w-4 sm:h-4 mr-2 group-hover:-translate-y-1 transition-transform" />
            Back to Top
          </Button>
        </div>
      </div>
