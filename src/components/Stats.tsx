      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="mb-12 sm:mb-16">
          <div className="text-center mb-8 sm:mb-12 slide-in-up">
            <h2 className="text-2xl sm:text-3xl font-bold text-gradient mb-3 sm:mb-4">Quick Overview</h2>
            <p className="text-sm sm:text-base text-muted-foreground">Numbers that define my journey</p>
          </div>
            ...
            {stats.map((stat, index) => (
              <Card key={stat.label} className={`tech-card text-center group slide-in-up stagger-${index + 1}`}>
                <div className="space-y-4">
                  <div className={`w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16 mx-auto rounded-full ${stat.bgColor} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-6 sm:mb-8 slide-in-up">
            <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4">Current Focus</h3>
            <p className="text-sm sm:text-base text-muted-foreground">What I'm working on right now</p>
          </div>
        ...
        {/* GitHub Stats */}
        <div className="mt-16 slide-in-up stagger-4">
