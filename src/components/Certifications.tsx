...
const Certifications = () => {
  ...
  const certifications = [
    {
      ...
      year: "2024",
      type: "Programming",
      logo: (<BrandImage localSrc={`${BASE}logos/python.svg`} remoteSrc="https://upload.wikimedia.org/wikipedia/commons/c/c3/Python-logo-notext.svg" alt="Python logo" />),
      color: "text-yellow-400",
      bgColor: "bg-yellow-400/10",
      link: `${BASE}python.jpg`
    },
    {
      ...
      year: "2024-05-16",
      type: "Programming",
      logo: (<BrandImage localSrc={`${BASE}logos/java.svg`} remoteSrc="https://upload.wikimedia.org/wikipedia/en/3/30/Java_programming_language_logo.svg" alt="Java logo" />),
      color: "text-yellow-400",
      bgColor: "bg-yellow-400/10",
      link: `${BASE}java.jpg`
    },
    ...
    },
    {
      ...
      link: `${BASE}Internship%20Completion%20Letter%20(1).pdf`
    },
    {
    ...
    },
    {
      ...
      color: "text-yellow-400",
      bgColor: "bg-yellow-400/10",
      link: `${BASE}Udemy%20certificate.pdf`
    },
    {
  ...
  const achievements = [
    ...
    },
    {
      ...
      logo: "💙",
      color: "text-blue-600",
      link: `${BASE}ibm-skillsbuild-ai1.pdf`,
    ...
    // Added from academic transcript (new, non-duplicates)
    {
      ...
      logo: "💙",
      color: "text-blue-600",
      link: `${BASE}ibm-skillsbuild-ai.pdf`,
      date: "September 19, 2024",
    ...
    <section id="certifications" className="py-20 bg-secondary/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12 sm:mb-16 slide-in-up">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gradient mb-4 sm:mb-6">Certifications & Achievements</h2>
        ...
        <div className="mb-12 sm:mb-16">
          <h3 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center">Professional Certifications</h3>
        ...
        {/* Achievement Badges */}
        <div>
          <h3 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-center">Skill Badges & Achievements</h3>
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
            {achievements.map((achievement, index) => (
              <Card
                key={achievement.title}
                className={`tech-card group slide-in-up stagger-${index + 1} ${(achievement as any).link ? 'cursor-pointer' : ''
                  }`}
                onClick={() => {
