    ...
    <section id="projects" className="py-20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="text-center mb-12 sm:mb-16 slide-in-up">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-gradient mb-4 sm:mb-6">Featured Projects</h2>
        ...
        <div className="text-center mt-12 slide-in-up stagger-3">
          <Button 
            className="btn-glow"
            onClick={() => window.open('https://github.com/Porallanagaraju13', '_blank', 'noopener,noreferrer')}
