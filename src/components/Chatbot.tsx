...
const Chatbot = () => {
  ...
  const generateBotResponse = (userMessage: string): string => {
    ...
    if (message.includes('contact') || message.includes('email') || message.includes('reach')) {
      return "You can reach Nagaraju through: 📧 Email: nagarajuporalla13@gmail.com, 🐙 GitHub: github.com/Porallanagaraju13, 💼 LinkedIn: linkedin.com/in/nagarajuporalla, 📍 Location: Hyderabad, Telangana, India. He's available for internship opportunities, freelance projects, and collaborative work in AI/ML and web development.";
    }
...
Contact: Email nagarajuporalla13@gmail.com, GitHub github.com/Porallanagaraju13, LinkedIn linkedin.com/in/nagarajuporalla
